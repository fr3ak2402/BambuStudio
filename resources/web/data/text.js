var LangText={
	...
	"zh_CN": {
		"t1": "欢迎使用GalaxySlicer neo",
		"t2": "GalaxySlicer neo需要几步安装步骤，让我们开始吧！",
		"t3": "用户使用协议",
		"t4": "拒绝",
		"t5": "同意",
		"t6": "帮助提升GalaxySlicer neo性能<br/>欢迎加入我们的客户体验改善计划",
		"t7": "允许发送匿名数据",
		"t8": "上一步",
		"t9": "下一步",
		"t10": "选择打印机",
		...
		"t52": "忽略",
		"t53": "同意",
		"t54": "在3D打印社区，我们从彼此的成功和失败中学习调整自己的切片参数和设置。GalaxySlicer neo遵循同样的原则，通过机器学习的方式从大量用户打印的成功和失败中获取经验，从而改善打印性能。我们正在通过向GalaxySlicer neo提供真实世界的数据来训练他们变得更聪明。如果您愿意，此服务将访问您的错误日志和使用日志中的信息，其中可能包括",
		"t55": "隐私政策",
		...
		"t81": "1, 点击",
		"t82": "打开插件所在目录",
		"t83": "2, 关闭所有GalaxySlicer neo",
		"t84": "3, 删除插件所在目录下的所有文件",
		"t85": "4, 重新启动GalaxySlicer neo并尝试安装插件",
		"t86": "关闭",
		"t87": "使用引导",
		"t88": "移除",
		"t89": "打开所在的文件夹",
		...
		"t116": "重试",
		"wk1": "快速入门指南",
		"wk2": "本文介绍了GalaxySlicer neo的最基本用法。它指导用户配置软件，创建项目，并逐步完成第一个打印任务。",
		"wk3": "基于项目的工作流",
		"wk4": "GalaxySlicer neo提出了领先的工作流程，真正实现了“一体化”项目。基于主流的3MF项目格式，它提供了一系列革命性的新功能，如支持多盘、项目资源管理器和装配/零件视图。它可以大幅提高模型创作者及普通用户的使用效率。",
		"wk5": "质量卓越的高速打印",
		"wk6": "在保持高质量的前提下进行高速打印是非常具有挑战性的。GalaxySlicer neo让这一切发生。支持“圆弧移动”特性使工具头移动更加顺滑，有效减少机器振动。基于不同材料类型的精细标定过的冷却控制参数，使得冷却过程可以自动开展。在悬垂区域进行“自动减速”，可防止高速打印时在此区域的外观瑕疵。",
		"wk7": "多色打印",
		"wk8": "GalaxySlicer neo提供了多种着色工具来制作彩色模型。您可以在项目中自由添加/移除打印材料，并使用不同的笔刷为模型着色。开始打印时，打印任务中的各个材料将自动映射到匹配的AMS槽位，无需手动调整AMS中的料卷位置。",
		"wk9": "切片参数设置指南",
		"wk10": "GalaxySlicer neo中的参数管理功能为切片过程提供了非常灵活和强大的控制。本文介绍了切片参数的组织分类和设置方法，并提供了一些使用技巧。",
		"wk11": "远程控制和监控",
		"wk12": "GalaxySlicer neo支持通过WAN/LAN网络向打印机发送打印任务，控制和查看3D打印机和打印任务的各个方面。如果您有多台打印机，还可以在设备列表中轻松切换。",
		"wk13": "STEP格式",
		"wk14": "与STL相比，STEP带来了更多有效的信息。由于STEP的高精度，切片时可以生成更多的圆弧路径。STEP还包括模型每个零件的装配关系，可分割模型后恢复装配视图。",
		"wk15": "3D文本",
		"wk16": "使用3D文本工具，用户可以轻松地在项目中创建各种3D文本形状，使模型更加个性化。GalaxySlicer neo提供了数十种字体，并支持粗体和斜体样式，使文本具有更大的灵活性。"
	},
	"ja_JP": {
		"t1": "GalaxySlicer neoへようこそ",
		"t2": "セットアップ",
		"t3": "利用規約",
		"t4": "同意しない",
		"t5": "同意",
		...
		"t81": "1. クリックして ",
		"t82": "プラグイン フォルダを開く",
		"t83": "2. 全て開いたGalaxySlicer neoを閉じる",
		"t84": "3. プラグイン フォルダのファイルを全て削除",
		"t85": "4. GalaxySlicer neoを開く、再度プラグインをインストールしてください",
		"t86": "閉じる",
		"t87": "ユーザ マニュアル",
		"t88": "削除",
		"t89": "フォルダを開く",
	...
	"it_IT": {
		...
		"t83": "2. Chiudi tutte le istanze di GalaxySlicer neo aperte",
		"t84": "3. Elimina tutti i file nella directory del plug-in",
		"t85": "4. Riapri GalaxySlicer neo e installa di nuovo il plug-in",
		"t86": "Chiudi",
		"t87": "Manuale utente",
		"t88": "Rimuovi",
	...
	"fr_FR": {
		"t1": "Bienvenue chez GalaxySlicer neo",
		"t2": "GalaxySlicer neo sera configuré en plusieurs étapes. Commençons !",
		...
		"t52": "Passer",
		"t53": "Rejoindre",
		"t54": "Dans la communauté de l'impression 3D, nous apprenons des succès et des échecs des autres pour ajuster nos propres paramètres de tranchage et de réglages. GalaxySlicer neo suit le même principe et utilise l'apprentissage automatique pour améliorer ses performances à partir des succès et des échecs du grand nombre d'impressions de nos utilisateurs. Nous entraînons GalaxySlicer neo à devenir plus intelligent en lui fournissant des données du monde réel. Si vous le souhaitez, ce service accédera aux informations de vos journaux d'erreurs et de vos journaux d'utilisation, qui peuvent inclure des informations décrites dans ",
		...
		"t83": "2, Fermez tous les GalaxySlicer neo ouverts",
		"t84": "3, Supprimez tous les fichiers du répertoire du plug-in",
		"t85": "4, Ré-ouvrez GalaxySlicer neo et installez le plug-in à nouveau",
		"t86": "Fermer",
	...
	"hu_HU": {
		...
		"t52": "Kihagy",
		"t53": "Csatlakozás",
		"t54": "A 3D nyomtatási közösségben tanulunk egymás sikeréből és kudarcából, hogy a saját szeletelési paramétereinket és beállításainkat igazítsuk. A GalaxySlicer neo ugyanezt az elvet követi, és gépi tanulást alkalmaz a felhasználóink által készített széles körű nyomatok sikerének és kudarcainak alapján. Azáltal, hogy a valódi világ adatait tápláljuk, okosabbá tanítjuk a GalaxySlicer neot. Ha hajlandó vagy, ez a szolgáltatás hozzáférhet az összes hibajegyzékéhez és használati naplójához, amelyek magukban foglalhatják a következő információkat: ",
		...
		"t83": "2, Zárja be az összes nyitott GalaxySlicer neo-t",
	...
	"es_ES": {
		"t1": "Bienvenido a GalaxySlicer neo",
		"t2": "GalaxySlicer neo se configurará en varios pasos. ¡Comencemos!",
		...
		"t52": "Saltar",
		"t53": "Unirse",
		"t54": "En la comunidad de impresión 3D, aprendemos de los éxitos y fracasos de los demás para ajustar nuestros propios parámetros y configuraciones de corte. GalaxySlicer neo sigue el mismo principio y utiliza el aprendizaje automático para mejorar su rendimiento a partir de los éxitos y fracasos de la gran cantidad de impresiones de nuestros usuarios. Estamos entrenando a GalaxySlicer neo para que sea más inteligente alimentándolos con datos del mundo real. Si lo desea, este servicio accederá a la información de sus registros de errores y registros de uso, que pueden incluir información descrita en ",
		...
		"t83": "2, Cierre todas las instancias de GalaxySlicer neo abiertas",
		"t84": "3, Elimine todos los archivos en el directorio del complemento",
		"t85": "4, Abra de nuevo GalaxySlicer neo e instale el complemento de nuevo",
		"t86": "Cerrar",
	...
	"sv_SE": {
		"t1": "Välkommen till GalaxySlicer neo",
		"t2": "GalaxySlicer neo kommer att ställas in i flera steg. Låt oss börja!",
		"t3": "Användaravtal",
		"t4": "Oenig",
		"t5": "Enig",
		...
		"t52": "Hoppa över",
		"t53": "Gå med",
		"t54": "I 3D-utskriftssamhället lär vi oss av varandras framgångar och misslyckanden för att justera våra egna skivparametrar och inställningar. GalaxySlicer neo följer samma princip och använder maskininlärning för att förbättra sin prestanda från användarnas stora antal utskrifters framgångar och misslyckanden. Vi tränar GalaxySlicer neo att bli smartare genom att mata dem med verkliga data. Om du är villig kommer denna tjänst att få åtkomst till information från dina felloggar och användningsloggar, som kan innehålla information som beskrivs i",
		...
		"t83": "2, Stäng alla öppna GalaxySlicer neo",
		"t84": "3, Radera alla filer under tilläggsbiblioteket",
		"t85": "4, Öppna GalaxySlicer neo igen och installera tillägget på nytt",
		"t86": "Stäng",
		"t87": "Användarmanual",
		"t88": "Ta bort",
	...
	"cs_CZ": {
		"t1": "Vítejte v GalaxySlicer neo",
		"t2": "GalaxySlicer neo bude nastaveno několika kroky. Začněme!",
		...
		"t52": "Přeskočit",
		"t53": "Připojit",
		"t54": "Ve společenství 3D tisku se učíme ze zkušeností druhých a z jejich neúspěchů, abychom upravili naše vlastní parametry a nastavení tisku. GalaxySlicer neo následuje stejný princip a pomocí strojového učení zlepšuje svou výkonnost na základě úspěchů a selhání velkého množství tisků našich uživatelů. Trénujeme GalaxySlicer neo, aby bylo chytřejší tím, že jim předáváme reálná data. Pokud jste ochotní, tato služba bude mít přístup k informacím z vašich chybových protokolů a protokolů o používání, které mohou obsahovat informace popsané v ",
		...
		"t83": "2, Zavřete všechny otevřené instance GalaxySlicer neo",
		"t84": "3, Smažte všechny soubory ve složce se zásuvnými moduly",
		"t85": "4, Znovu spusťte GalaxySlicer neo a zásuvný modul znovu nainstalujte",
		"t86": "Zavřít",
	...
	"uk_UA": {
		"t1": "Вітаємо в GalaxySlicer neo!",
		"t2": "Для налаштування GalaxySlicer neo необхідно пройти кілька етапів. Почнімо!",
		...
		"t52": "Пропустити",
		"t53": "Увійти",
		"t54": "У спільноті 3D-друкарів для виявлення найкращих параметрів нарізки та покращення друку ми вчимося на успіхах та невдачах один одного. GalaxySlicer neo слідує тому ж принципу і використовує машинне навчання для покращення своєї роботи на основі успішних та невдалих друків наших користувачів. Ми навчаємо GalaxySlicer neo бути розумнішим на основі реальних даних. За вашою згодою ця служба отримає доступ до ваших журналів помилок та журналів використання, в яких містяться дані, описані в ",
		...
		"t83": "2, Закрийте всі відкриті GalaxySlicer neo",
		"t84": "3, Видаліть всі файли у папці плагіна",
		"t85": "4, Відкрийте GalaxySlicer neo та знову встановіть підключуваний модуль.",
		"t86": "Закрити",
		"t87": "Інструкції",
		"t88": "Видалити",
	...
	"ru_RU": {
		"t1": "Приветствуем в GalaxySlicer neo!",
		"t2": "Для настройка GalaxySlicer neo необходимо пройти несколько этапов. Давайте начнём!",
		...
		"t52": "Пропустить",
		"t53": "Войти",
		"t54": "В сообществе 3D-печатников для выявления наилучших параметров нарезки и улучшения печати мы учимся на успехах и неудачах друг друга. GalaxySlicer neo следует тому же принципу и использует машинное обучение для улучшения своей работы на основе успешных и неудачных печатей наших пользователей. Мы обучаем GalaxySlicer neo быть умнее на основе реальных данных. По вашему согласию эта служба получит доступ к вашим журналам ошибок и журналам использования, в которых содержатся сведения, описанные в ",
		...
		"t83": "2, Закрыть все открытые GalaxySlicer neo",
		"t84": "3, Удалить все файлы в папке плагина",
		"t85": "4, Откройте GalaxySlicer neo и снова установите подключаемый модуль.",
		"t86": "Закрыть",
		"t87": "Инструкции",
		"t88": "Удалить",
	...
	"tr_TR": {
		...
		"t2": "GalaxySlicer neo birkaç adımda kurulacaktır. Hadi başlayalım!",
		...
		"t52": "Atla",
		"t53": "Katıl",
		"t54": "3D Baskı topluluğunda, kendi dilimleme parametrelerimizi ve ayarlarımızı ayarlamak için birbirimizin başarılarından ve başarısızlıklarından öğreniyoruz. GalaxySlicer neo da aynı prensibi izliyor ve kullanıcılarımız tarafından yapılan çok sayıda baskının başarı ve başarısızlıklarından performansını artırmak için makine öğrenimini kullanıyor. GalaxySlicer neo'yu gerçek dünya verileriyle besleyerek daha akıllı olması için eğitiyoruz. İsterseniz, bu hizmet hata günlüklerinizden ve kullanım günlüklerinizden aşağıdaki bilgileri içerebilecek bilgilere erişecektir ",
		"t55": "Privacy Policy",
		...
		"t83": "2, Tüm açık GalaxySlicer neoyu kapatın ",
		"t84": "3, Eklenti dizini altındaki tüm dosyaları silin",
		"t85": "4, GalaxySlicer neoyu yeniden açın ve eklentiyi tekrar yükleyin",
		"t86": "Kapat",
	...
	"pt_BR": {
		"t1": "Bem-vindo ao GalaxySlicer neo",
		"t2": "GalaxySlicer neo será configurado em algumas etapas. Vamos começar!",
		"t3": "Termos de Uso",
		"t4": "Discordo",
		"t5": "Concordo",
		...
		"t83": "2, Feche totalmente o GalaxySlicer neo",
		"t84": "3, Delete todos os arquivos na pasta do plug-in",
		"t85": "4, Reabra o GalaxySlicer neo e instale o plug-in novamente",
		"t86": "Fechar",
	...
	"ko_KR": {
		"t1": "GalaxySlicer neo에 오신 것을 환영합니다",
		"t2": "GalaxySlicer neo는 몇 단계로 설정됩니다. 시작하겠습니다!",
		"t3": "사용자 계약",
		"t4": "동의하지 않음",
		"t5": "동의",
		...
		"t52": "건너뛰기",
		"t53": "가입",
		"t54": "3D 프린팅 커뮤니티에서는 서로의 성공과 실패를 배우고 자신의 슬라이싱 매개변수와 설정을 조정합니다. GalaxySlicer neo는 동일한 원칙을 따르고 기계 학습을 사용하여 우리 사용자들의 방대한 인쇄의 성공과 실패로 그 성능을 개선합니다. 우리는 실제 데이터를 공급하여 GalaxySlicer neo를 더 똑똑하게 훈련시키고 있습니다. 귀하가 원한다면 이 서비스는 오류 로그 및 사용 로그의 정보에 액세스할 것입니다. 여기에는 다음에 설명된 정보가 포함될 수 있습니다.",
		"t55": "개인 정보 정책",
		...
		"t81": "1, 클릭 ",
		"t82": " 플러그인 디렉토리 열기",
		"t83": "2, 모든 GalaxySlicer neo 닫기",
		"t84": "3, 플러그인 디렉토리의 모든 파일 삭제",
		"t85": "4, GalaxySlicer neo를 다시 열고 플러그인을 다시 설치하십시오",
		"t86": "닫기",
		"t87": "사용자 매뉴얼",
		"t88": "제거",
		"t89": "포함 폴더 열기",
	...
	"pl_PL": {
		"t1": "Witamy w GalaxySlicer neo",
		"t2": "Konfiguracja GalaxySlicer neo odbywa się w kilka kroków. Zacznijmy!",
		...
		"t52": "Pomiń",
		"t53": "Dołącz",
		"t54": "W społeczności drukowania 3D uczymy się od sukcesów i porażek innych, aby dostosować nasze parametry cięcia i ustawienia. GalaxySlicer neo działa na tej samej zasadzie i wykorzystuje uczenie maszynowe, aby poprawiać swoją wydajność na podstawie sukcesów i niepowodzeń licznych wydruków naszych użytkowników. Trenujemy GalaxySlicer neo, aby stać się mądrzejszą, dostarczając rzeczywiste dane z życia. Jeśli jesteś zainteresowany, ta usługa będzie mieć dostęp do informacji z Twoich dzienników błędów i dzienników użytkowania, które mogą zawierać informacje opisane w",
		...
		"t83": "2, Zamknij wszystkie otwarte GalaxySlicer neo",
		"t84": "3, Usuń wszystkie pliki w katalogu wtyczki",
		"t85": "4, Otwórz ponownie GalaxySlicer neo i zainstaluj wtyczkę ponownie",
		"t86": "Zamknij",
