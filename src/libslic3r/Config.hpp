...
// When parsing a configuration value, if the old_value is not understood by this GalaxySlicerNeo version,
// it is being substituted with some default value that this GalaxySlicerNeo could work with.
