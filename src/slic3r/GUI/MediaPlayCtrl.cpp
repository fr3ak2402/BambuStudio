    ...
    , m_media_ctrl(media_ctrl)
{
    ...
    m_label_status->Bind(wxEVT_LEFT_UP, [this](auto &e) {
        auto url = wxString::Format(L"https://wiki.bambulab.com/%s/software/galaxyslicer-neo/faq/live-view", L"en");
