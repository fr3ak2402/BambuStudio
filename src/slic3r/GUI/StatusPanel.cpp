...
void PrintingTaskPanel::create_panel(wxWindow* parent)
{
   ...
   /* wxFlexGridSizer *fgSizer_task = new wxFlexGridSizer(2, 2, 0, 0);
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(AMS_CONTROL_DISABLE_COLOUR, StateColor::Disabled), std::pair<wxColour, int>(wxColour(69, 43, 74), StateColor::Pressed),
                            std::pair<wxColour, int>(wxColour(153, 102, 166), StateColor::Hovered), std::pair<wxColour, int>(AMS_CONTROL_BRAND_COLOUR, StateColor::Normal));
...
void ScoreDialog::init() {
    ...
    // icon
    std::string icon_path = (boost::format("%1%/images/GalaxySlicerNeo.ico") % resources_dir()).str();
