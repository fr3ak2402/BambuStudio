    ...
    , m_show_history_dialog(show)
{
    ...
    mew_btn->SetBorderColor(wxColour(105, 58, 113));
...
void HistoryWindow::sync_history_data() {
    ...
    for (auto& result : m_calib_results_history) {
        ...
        StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(69, 43, 74), StateColor::Pressed),
    ...
    , m_history_results(history_results)
{
    ...
    ok_btn->SetBorderColor(wxColour(105, 58, 113));
