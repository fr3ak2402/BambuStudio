...
#define SELECT_ALL_OPTION_COLOUR wxColour("#693A71")
#define DEFAULT_PROMPT_TEXT_COLOUR wxColour("#ACACAC")

namespace Slic3r { 
namespace GUI {

//GalaxySlicerNeo: remove const to be able to sort the is during runtime.
static std::vector<std::string> filament_vendors = {"Polymaker", "OVERTURE", "Kexcelled", "HATCHBOX",  "eSUN",       "SUNLU",    "Prusament", "Creality", "Protopasta",
                                                    ...
                                                    "Dremel", "Innofil", "Francofil", "Fiberthree", "NinjaTek", "DSM", "Siddament", "Z-Polymers"};
...
{ 
    ...
    std::string      wiki_url             = "https://wiki.bambulab.com/en/software/galaxyslicer-neo/3rd-party-printer-profile";
...
wxBoxSizer *CreatePrinterPresetDialog::create_hot_bed_stl_item(wxWindow *parent)
{
    ...
    StateColor flush_bg_col(std::pair<wxColour, int>(wxColour(153, 133, 171), StateColor::Pressed), std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Hovered),
                            std::pair<wxColour, int>(wxColour(238, 238, 238), StateColor::Normal));

    StateColor flush_bd_col(std::pair<wxColour, int>(wxColour(105, 58, 113), StateColor::Pressed), std::pair<wxColour, int>(wxColour(105, 58, 113), StateColor::Hovered),
...
wxPanel *PresetTree::get_child_item(wxPanel *parent, std::shared_ptr<Preset> preset, std::string printer_name, int preset_index, bool is_last)
{
    ...
    if (base_id_error) {
        std::string      wiki_url             = "https://wiki.bambulab.com/en/software/galaxyslicer-neo/custom-filament-issue";
