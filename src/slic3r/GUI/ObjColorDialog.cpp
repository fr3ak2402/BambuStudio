...
const  StateColor ok_btn_bg(std::pair<wxColour, int>(wxColour(69, 43, 74), StateColor::Pressed),
...
{
    std::string icon_path = (boost::format("%1%/images/GalaxySlicerNeoTitle.ico") % Slic3r::resources_dir()).str();
...
{
    auto       btn_sizer = new wxBoxSizer(wxHORIZONTAL);
    StateColor calc_btn_bg(std::pair<wxColour, int>(wxColour(69, 43, 74), StateColor::Pressed), std::pair<wxColour, int>(wxColour(153, 102, 166), StateColor::Hovered),
                           std::pair<wxColour, int>(wxColour(105, 58, 113), StateColor::Normal));
    StateColor calc_btn_bd(std::pair<wxColour, int>(wxColour(105, 58, 113), StateColor::Normal));
