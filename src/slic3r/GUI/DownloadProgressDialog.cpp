...
{
    wxString download_failed_url = wxT("https://wiki.bambulab.com/en/software/galaxyslicer-neo/failed-to-get-network-plugin");
    wxString install_failed_url = wxT("https://wiki.bambulab.com/en/software/galaxyslicer-neo/failed-to-get-network-plugin");
