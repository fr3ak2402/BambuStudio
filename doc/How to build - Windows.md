...
## building the deps
Suppose you download the codes into D:/work/Projects/GalaxySlicerNeo  
create a directory to store the dependence built: D:/work/Projects/GalaxySlicerNeo_dep

`cd GalaxySlicerNeo/deps`  
`mkdir build;cd build`  
`cmake ../ -G "Visual Studio 16 2019" -DDESTDIR="D:/work/Projects/GalaxySlicerNeo_dep" -DCMAKE_BUILD_TYPE=Release`  
...
create a directory to store the installed files at D:/work/Projects/GalaxySlicerNeo/install_dir  
`cd GalaxySlicerNeo`  
`mkdir install_dir`  
`mkdir build;cd build`  
...
`cmake .. -G "Visual Studio 16 2019" -DBBL_RELEASE_TO_PUBLIC=1 -DCMAKE_PREFIX_PATH="D:/work/Projects/GalaxySlicerNeo_dep/usr/local" -DCMAKE_INSTALL_PREFIX="../install_dir" -DCMAKE_BUILD_TYPE=Release -DWIN10SDK_PATH="C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0"` 

then build it using command  
`cmake --build . --target install --config Release`  

or building it under the Visual Studio 2019  
(set the GalaxySlicerNeo_app_gui as start project)  
